        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
            <form>
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="mb-4">
                        <label for="nombresector"  class="text-gray-700 text-sm font-bold mb-2">Nombre del sector</label>
                        <textarea id="nombresector" wire:model.defer="nombresector" rows="5" class="shadow appearance-none rounded  w-full py-2 px-3 text-gray-700 bg-gray-50 leading-tight focus:outline-none focus:shadow-outline" placeholder="ingresa el nombre del sector ?..." ></textarea>
                        @error('nombresector')
